...
resultado_final <- bind_rows(
  tibble(.metric = "accuracy", .estimate = accuracy_general$.estimate),
  tibble(.metric = "TCC_clase_0", .estimate = tcc_clase_0$.estimate),
  tibble(.metric = "TCC_clase_1", .estimate = tcc_clase_1$.estimate)
)
