...
df_Seleccion_EP <- data %>% select( V2, Y)
...
train_data_EP <- training(split_interacciones)
test_data_EP  <- testing(split_interacciones)
...
```{r}
modeloLogitInteracciones<- salidaModelos(grid_fit, workflow_modelado, trainingDat = train_data_interacciones, testing_data = test_data_interacciones)
df_resultados <-nueva_fila_resultados ("Modelo Largo", modeloLogitInteracciones$accuracy, modeloLogitInteracciones$tcc_clase_0, modeloLogitInteracciones$tcc_clase_1)
```
...
modelo4<- salidaModelos(grid_fit3, workflow_modelado3)
df_resultados <-nueva_fila_resultados ("Modelo Probit", modelo4$accuracy, modelo4$tcc_clase_0, modelo4$tcc_clase_1)
