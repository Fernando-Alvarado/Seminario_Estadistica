...
salidaModelos <- function(grid, workflow, trainingDat =train_data ){
...
df_Seleccion_Interacciones <- interacciones_df %>% select(
  V5, V6, V7, V10, V11_x_V21,  V11_x_V41, V21_x_V41,V21_x_V5 , V21_x_V6 , V21_x_V7 ,V31_x_V7, V31_x_V8 , V41_x_V5 , V41_x_V8, V41_x_V10, V5_x_V6 , V6_x_V8 , V7_x_V8 , V8_x_V9 , V9_x_V10 )

df_Seleccion_EP <- data %>% select(
  V2)
```
...
split_interacciones <- initial_split(interacciones_df, prop = 0.8, strata = Y) # Haciendo la division de los datos en training y test
